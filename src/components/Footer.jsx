...
function Footer() {
  return (
    <div className="flex gap-5 w-full h-screen tracking-tighter bg-zinc-900 font-bold  font-['Test Founders_Grotesk X-Cond SmBd']">
      <div className='w-1/2 h-full flex flex-col justify-between px-20'>
        <div className="heading">
          <h1 className="text-[5vw] font-bold uppercase leading-none -mb-30">
            Eye-
          </h1>
          <h1 className="text-[5vw] font-bold uppercase leading-none -mb-30">
            Opening
      ...
      <div className="w-1/2">
      <h1 className="text-[6vw] font-bold uppercase leading-none tracking-tighter -px-10 -mb-30">
            Presentations
          </h1>
